...
func (in *ActivationStatus) DeepCopyInto(out *ActivationStatus) {
	*out = *in
	if in.OriginRegistrationRef != nil {
		in, out := &in.OriginRegistrationRef, &out.OriginRegistrationRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProductClass) DeepCopyInto(out *ProductClass) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProductClass.
func (in *ProductClass) DeepCopy() *ProductClass {
	if in == nil {
		return nil
	}
	out := new(ProductClass)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RegistrationSpec) DeepCopyInto(out *RegistrationSpec) {
	*out = *in
	...
	if in.RegistrationCertificateSecretRef != nil {
		in, out := &in.RegistrationCertificateSecretRef, &out.RegistrationCertificateSecretRef
		*out = new(corev1.SecretReference)
		**out = **in
	}
	return
...
func (in *RegistrationStatus) DeepCopyInto(out *RegistrationStatus) {
	*out = *in
	...
	in.SubscriptionInfo.DeepCopyInto(&out.SubscriptionInfo)
	if in.SystemCredentialsSecretRef != nil {
		in, out := &in.SystemCredentialsSecretRef, &out.SystemCredentialsSecretRef
		*out = new(corev1.SecretReference)
		**out = **in
